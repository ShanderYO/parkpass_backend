...
from rps_vendor.views import (
    RpsCreateParkingSessionView,
    RpsCancelParkingSessionView,
    RpsUpdateParkingSessionView,
    RpsCompleteParkingSessionView,
    RpsParkingSessionListUpdateView,
    MockingGetParkingCardDebt,
    MockingOrderAuthorized,
    MockingOrderConfirm,
    MockingOrderRefund,
    GetParkingCardRedirect,
    GetParkingCardDebt,
    InitPayDebt,
    AccountInitPayment,
    GetCardSessionStatus,
    SubscriptionCallbackView,
    RpsCreateOrGetAccount,
    SubscriptionUpdateView,
    GetDeveloperParkingCardDebt,
    ConfirmPayDeveloperDebt,
    CheckTimestamp,
    ResetDeveloperToken,
    send_push_notifications,
    check_remote_network,
    GetCardSessionStatusForDeveloper,
...
urlpatterns = [
    ...
    url(
        r"^developer/cards/payment/status/$", GetCardSessionStatusForDeveloper.as_view()
    ),
