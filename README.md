...
```
Для тестирования API <b>можно</b> использовать эти параметры. Данному тестовому вендору также принадлежит парковка с id=1
...
```
Информацию о ```hmac``` можно найти [здесь](https://ya.ru).
