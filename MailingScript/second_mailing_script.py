...
def main():
    ...
    for email in emails:
        ...
        try:
            ...
            msg_html = render_to_string('emails/ios-template-2.html', {'email': base64_email})
            message = ('Ссылка на ParkPass  3.0 Beta', '', msg_html, DEFAULT_FROM_EMAIL, [email])
